...
This repository was created with the intent of teaching us how to create an enumerable based on the the ["Create your own Enumerable"](https://github.com/microverseinc/curriculum-ruby/blob/main/simple-ruby/create_your_own_enumerable.md) activity using ruby.
...
**ruby-enumerable** is a repository that includes two ruby files that were used to complete this activity.
